...
using ShyCharlieBot.Bot;

namespace ShyCharlieBot
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            try
            {
                botConfig = BotConfiguration.Load(botFilePath ?? @".\ShyCharlie.bot", secretKey);
            }
            catch
            {
    ...
    ";
            ...
            services.AddBot<MessageBot>(options =>
            {
                options.CredentialProvider = new SimpleCredentialProvider(endpointService.AppId, endpointService.AppPassword);

                // Catches any errors that occur during a conversation turn and logs them to currently
                // configured ILogger.
                ILogger logger = _loggerFactory.CreateLogger<MessageBot>();
